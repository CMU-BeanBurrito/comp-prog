 ...
 * Strategy:
 * 
 * Track number of valid subseq that end in a, b, c.
 * 
 * When we read next char x, every subsequence that did not end x
 * can be extended by appending x. So if x is c, c += (a+b).
 * 
 * Also, there is another new valid subsequence of just x. So if x is c, c += 1.
 */
...
void solve() {
    ...
    // number of valid subseq that end in a, b, c respectively
    ll a = 0LL;
    ll b = 0LL;
    ll c = 0LL;
