...
void solve() {
    ...
    for (int i = 0; i < 6; i++)
    {
        ...
        for (int j = 0; j < 6; j++)
        {
            ...
            {
                r[2] = c[k];
                if (r[0] == 4 && r[1] == 5 && r[2] == 6) num++;
                if (r[0] == 4 && r[1] == 6 && r[2] == 5) num++;
                if (r[0] == 5 && r[1] == 4 && r[2] == 6) num++;
                if (r[0] == 5 && r[1] == 6 && r[2] == 4) num++;
                if (r[0] == 6 && r[1] == 4 && r[2] == 5) num++;
                if (r[0] == 6 && r[1] == 5 && r[2] == 4) num++;
            }
        }
    }

    printf("%.6f", 1.0*num/216.0);
}
