...
void solve() 
{
    ...
    /**
     * To leave a certain digit d left standing, we just have to make the count of the other digits equal.
     * We can do this if the sum of the other 2 are even.
     */

    printf("%d %d %d\n", (b+c) % 2 == 0 ? 1 : 0, (a+c) % 2 == 0 ? 1 : 0, (a+b) % 2 == 0 ? 1 : 0);
}
