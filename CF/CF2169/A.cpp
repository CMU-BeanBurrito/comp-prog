 ...
 * Strategy: 
 * 
 * Alice will get the point for any marbles whose value is equal to a, no matter what we do.
 * 
 * So, we can choose to get points for all the marbles with value greater than a,
 * or points for all the marbles with value lesser than a.
 * 
 * If there are more marbles with value greater than a, then Bob can pick a+1 to get all of them.
 * If there are more marbles with value lesser than a, then Bob can pick a-1 to get all of them.
 */
