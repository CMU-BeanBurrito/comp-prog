...
// PUT GLOBALS HERE
vector<vector<int>> g (200'005, vector<int> ());
vector<int> a (200'005);
vector<bool> vis (200'005, false);
vector<ll> sm (200'005, 0LL);
vector<ll> ans (200'005, 0LL);
vector<int> level (200'005, 0);
