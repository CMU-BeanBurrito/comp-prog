...
/**
 * ans[i] is the number of nodes in i's connected component.
 * 
 * structure of connected components doesn't matter. so we make each one a linked list.
 * 
 * when conducting DFs, assign each node to its connected component/canonical representative
 * 
 * when printing answer for node i, check size of i's canonical representative's connected component.
 */
...
void solve() {
    ...
    for (int i = 1; i <= n; i++) printf("%d ", mp[cr[i]]);
    printf("\n");
}
