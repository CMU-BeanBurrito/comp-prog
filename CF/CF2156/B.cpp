 ...
 * Strategy: 
 * 
 * By doing a full simulation, we can process each query in log(x) time as long as there is
 * at least one B machine.
 * 
 * If there are no B machines, then a -> 0 will take a seconds.
 */
