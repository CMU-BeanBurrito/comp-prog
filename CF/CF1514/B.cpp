...
void solve() 
{
    ...
    // answer is n to the power of k
    // set all elements ot 2^k - 1
    // for each bit, choose one element and set that bit to 0
    // k bits, each can independently choose one of n elements
