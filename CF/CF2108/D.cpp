...
void solve() {
    ...
    for (int i = 0; i < n; i++) aa[i] = a[i%k];
    for (int i = n-1; i >= n-k; i--) bb[i] = b[i-(n-k)];
    for (int i = n-k-1; i >= 0; i--) bb[i] = bb[i+k];
