 ...
 * Strategy:
 * 
 * Take p to be the subsequence of all 0s in s. Obviously, p is non-decreasing.
 * 
 * The remaining elements in s will all be 1s, or the remaining string is empty. So it is a palindrome.
 */
...
void solve() {
    ...
    for (int i = 0; i < n; i++)
    {
        if (s[i] == '0') ans.push_back(i+1); // problem uses 1-indexing
    }
