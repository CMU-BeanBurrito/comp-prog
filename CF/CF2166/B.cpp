 ...
 * Strategy:
 * 
 * Only need to put mouse at a, b, or both. So never have to move mouse more than twice.
 */
...
void solve() {
    ...
    if (b <= a/n) // end of first tab will always be at b.
    {
        printf("1\n");
    }
    else if (b == a) // end of last tab will always be at a.
    {
        printf("1\n");
    }
    else // end of last tab will be at b until some point. from then onwards, end of first tab will always be at b.
    {
        printf("2\n");
    }
}
