...
/**
 * We cannot have any strings "FFT" or "NTT".
 * 
 * One way to solve this is to sort the string in reverse order, as "FFT" and "NTT" are sorted in ascending order.
 * 
 * So in the final string, all Ts will precede all Ns and Fs.
 * 
 * We can simply count the frequency of each character, and then iterate from Z to A,
 * outputting each character however many times we saw them.
 */
