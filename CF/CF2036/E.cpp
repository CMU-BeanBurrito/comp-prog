...
void solve() {
    ...
    while(q--)
    {
        ...
        while(m--)
        {
            ...
            if (o == '>') // find first country whose rth region has value > c
            {
                while(left < right)
                {
            ...
            else // find last country whose rth region has value < c
            {
                while(left < right)
                {
                    int mid = (right+left)/2;
                ...
                // we actually found the first country whose rth region has value >= c.
                left--;
