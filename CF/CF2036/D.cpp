...
void solve() {
    ...
    {
        vector<int> layer;
        for (int i = L; i < m-L-1; i++) layer.push_back(a[L][i]);
        for (int i = L; i < n-L-1; i++) layer.push_back(a[i][m-L-1]);
        for (int i = m-L-1; i > L; i--) layer.push_back(a[n-L-1][i]);
        for (int i = n-L-1; i > L; i--) layer.push_back(a[i][L]);
        ...
        if (layer[k-3] == 1 && layer[k-2] == 5 && layer[k-1] == 4 && layer[0] == 3) ans++;
        if (layer[k-2] == 1 && layer[k-1] == 5 && layer[0] == 4 && layer[1] == 3) ans++;
        if (layer[k-1] == 1 && layer[0] == 5 && layer[1] == 4 && layer[2] == 3) ans++;
    }
