...
void solve() {
    ...
    while(q--)
    {
        ...
        int oldsp = 0;
        if (i >= 3 && s.substr(i-3, 4) == "1100") oldsp++;
        if (i >= 2 && i < n-1 && s.substr(i-2, 4) == "1100") oldsp++;
        if (i >= 1 && i < n-2 && s.substr(i-1, 4) == "1100") oldsp++;
        if (i < n-3 && s.substr(i, 4) == "1100") oldsp++;

        s[i] = v;

        int newsp = 0;
        if (i >= 3 && s.substr(i-3, 4) == "1100") newsp++;
        if (i >= 2 && i < n-1 && s.substr(i-2, 4) == "1100") newsp++;
        if (i >= 1 && i < n-2 && s.substr(i-1, 4) == "1100") newsp++;
        if (i < n-3 && s.substr(i, 4) == "1100") newsp++;
